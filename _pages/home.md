...
<ul>
	<li>Presentation (3 MB) <a href="#" class="btn btn--primary">Download</a></li>
	<li>Poster (6 MB) <a href="#" class="btn btn--primary">Download</a></li>
	<li>Pitch Deck (330 KB) <a href="#" class="btn btn--primary">Download</a></li>
</ul>
